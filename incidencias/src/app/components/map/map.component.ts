...
export class MapComponent implements AfterViewInit {
    ...
    getNumber(event: Event) {
        ...
        // this.traficoDenso2(this.numberCtrl.value)
        console.log(this.ajustarHora(this.timeCtrl.value));       
        this.traficoDenso2(this.ajustarHora(this.timeCtrl.value))
    }
